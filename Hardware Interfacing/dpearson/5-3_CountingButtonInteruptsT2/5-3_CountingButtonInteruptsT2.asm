...
SETUP: 								; set the ports for the led outputs and clear them, set the counter value to 0, setup the interupts
	...
	SBI PORTD, 4					; activates pullups on d4
	...
	LDI TMP1, 0x0e					; load an immediate value to tmp1 of 0000 1110 int0 falling and rising edge, int1 rising see page 67 to 69
