...
MAINLOOP:
	...
	SBIS PIND, 2			; if switch 3 is pressed jump to tunr on status led
	RCALL LED3		
	SBIC PIND, 3			; if its 0 turn off the led
	CBI PORTB, 3
...
; 4th light
	...
	CBI DDRD, 3				
	SBI PORTD, 3
; LED 9 - sets it to a data output port and then clears the value
	SBI DDRB, 4
	CBI PORTB, 4
